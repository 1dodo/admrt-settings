...
<path d="M6.91209 13.9167H6.91957" stroke="#2B59FF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <input
        datepicker
        type="text"
        className="bg-gray-50 border border-gray-300  py-3 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5"
