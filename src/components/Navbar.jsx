...
import search from '../Layout/images/search-normal.svg'
import userPhoto from '../Layout/images/Group 1000005937.svg'
          ...
          <div className="flex items-center justify-between text-blue-gray-900">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="/register">
                ...
                <a href="/login">
                <div>
                  <button className='buttonSignUp font-semibold hover:bg-blue-100'>Sign Up</button>
                </div>
                </a>
              </div>
              <IconButton
          ...
          <MobileNav open={openNav}>
            ...
            <div className="flex items-center gap-x-1">
              <Button fullWidth variant="text" size="sm" className="">
                <span><a href="/register">Sign In</a></span>
              </Button>
